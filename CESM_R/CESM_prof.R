...
# tagged runs
prof_data_tagged <- array(c(run_015601, run_015605, run_018405, run_0111205, run_0111210, 
                            run_0114010, run_0122410, run_0122405, run_0122401, run_0119610,
                            run_0119605,  run_0119601, run_012805)
                          , dim = c(length(run_0111205), 13, 1))
...
prof_data_not <- array(c(run_025601, run_025605, run_028405_2, run_0211205, run_0211210,
                         ...
                         run_028410, run_025610),
                       dim = c(length(run_0211205),17,1))
...
# Total duration
plot(ndays5_notag$Cores, ndays5_notag$Dur_tot, pch=15, type = "p", col="darkblue", ylim=c(500, 3000),
     main="Total Duration", xlab="Number of cores", ylab="Duration in seconds")
points(ndays10_notag$Cores, ndays10_notag$Dur_tot, pch=16, type = "p", col="red")

# Init duration
plot(ndays5_notag$Cores, ndays5_notag$Dur_init, pch=15, type = "p", col="darkblue", ylim=c(20, 100),
     main="Init Duration", xlab="Number of cores", ylab="Duration in seconds")
points(ndays10_notag$Cores, ndays10_notag$Dur_init, pch=16, type = "p", col="red")

# Run duration
plot(ndays5_notag$Cores, ndays5_notag$Dur_run, pch=15, type = "p", col="darkblue", ylim=c(500, 2500),
     main="Run Duration", xlab="Number of cores", ylab="Duration in seconds")
points(ndays10_notag$Cores, ndays10_notag$Dur_run, pch=16, type = "p", col="red")

# Fin duration
plot(ndays5_notag$Cores, ndays5_notag$Dur_fin, pch=15, type = "p", col="darkblue", ylim=c(0, 0.05),
     main="Finish Duration", xlab="Number of cores", ylab="Duration in seconds")
points(ndays10_notag$Cores, ndays10_notag$Dur_fin, pch=16, type = "p", col="red")

## TAGGED ####--------------------------------------------------------------------
# Total duration
plot(ndays5_tag$Cores, ndays5_tag$Dur_tot, pch=15, type = "p", col="darkblue", ylim=c(1000, max(ndays10_tag$Dur_tot)),
     main="Total Duration", xlab="Number of cores", ylab="Duration in seconds")
points(ndays10_tag$Cores, ndays10_tag$Dur_tot, pch=16, type = "p", col="red")

# Init duration
plot(ndays5_tag$Cores, ndays5_tag$Dur_init, pch=15, type = "p", col="darkblue", ylim=c(20, max(ndays10_tag$Dur_init)),
     main="Init Duration", xlab="Number of cores", ylab="Duration in seconds")
points(ndays10_tag$Cores, ndays10_tag$Dur_init, pch=16, type = "p", col="red")

# Run duration
plot(ndays5_tag$Cores, ndays5_tag$Dur_run, pch=15, type = "p", col="darkblue", ylim=c(500, max(ndays10_tag$Dur_run)),
     main="Run Duration", xlab="Number of cores", ylab="Duration in seconds")
points(ndays10_tag$Cores, ndays10_tag$Dur_run, pch=16, type = "p", col="red")

# Fin duration
plot(ndays5_tag$Cores, ndays5_tag$Dur_fin, pch=15, type = "p", col="darkblue", ylim=c(0, max(ndays10_tag$Dur_fin)),
     main="Finish Duration", xlab="Number of cores", ylab="Duration in seconds")
points(ndays10_tag$Cores, ndays10_tag$Dur_fin, pch=16, type = "p", col="red")
